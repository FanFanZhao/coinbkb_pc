export default {
  ...
  header:{
    ...
    mycandy:'my candy',
    candychange:'exchange',
    candyname:'candy',
    candy_number:'get number',
    candy_invite:'invite number',
    candy_tip:'Candy exchange needs to enter QQ group',
    candy_balance:'candy available',
    candy_duihuan:'exchange',
    candy_notopen:'exchange is not open,please enter the qq group',
    coin:'Coin currency',
    show:'demonstrat',
    wakuang:'trading dig',
  },
  footer:{
    legalTrade:'legal trade',
     ...
     anzhuo:'android download',
     appledown:'ios download',
  ...
  account:{
    ...
    suocang:'lock',
    lock_balance:'available balance',
    lock_number:'lock number',
    mei:'枚',
    lock_confirm:'confirm lock',
    lock_remain:'available balance',
